...
const PLAYLIST_IMAGE = "https://media.discordapp.net/attachments/1249776327456854048/1266847146645393458/bmc.png?ex=66a6a2d8&is=66a55158&hm=30e6fb08f3cd94e7067b0cd6a7bc474247e0f270d2d4910a2d47e0bf8343edb4&=&format=webp&quality=lossless&width=383&height=385";
...
export async function checkPlaylist() {
    try {
        ...
        const newTracks = tracks.filter((track) => !lastTracks.includes(track.track?.id));
